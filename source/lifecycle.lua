...
-- See https://sdk.play.date/Inside%20Playdate.html#game-lifecycle for more information
...
--- This is a good time to update the [menu image](https://sdk.play.date/Inside%20Playdate.html#f-setMenuImage).
